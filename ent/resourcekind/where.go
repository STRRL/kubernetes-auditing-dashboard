...
func And(predicates ...predicate.ResourceKind) predicate.ResourceKind {
	return predicate.ResourceKind(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.ResourceKind) predicate.ResourceKind {
	return predicate.ResourceKind(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.ResourceKind) predicate.ResourceKind {
	return predicate.ResourceKind(sql.NotPredicates(p))
}

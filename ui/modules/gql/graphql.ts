...
export type GetResourceLifecycleQuery = { __typename?: 'Query', resourceLifecycle: Array<{ __typename?: 'LifecycleEvent', id: string, type: EventType, timestamp: any, user: string, userAgent: string, resourceState: any, diff?: { __typename?: 'ResourceDiff', added?: any | null, removed?: any | null, modified: Array<{ __typename?: 'DiffEntry', path: string, oldValue: any, newValue: any }> } | null }> };
